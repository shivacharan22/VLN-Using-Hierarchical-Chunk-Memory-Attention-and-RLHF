...
class Contra_Dataset(Dataset):
    def __init__(self):
        ...
        self.df["action"] = df.iloc[:, 5].apply(lambda x: 1 if x==1 else -1)
    ...
    def __getitem__(self, idx):
        ...
        #img1 = self.image_processor(img1)
        #img2 = self.image_processor(img2)
...
class wavmosLit(pl.LightningModule):
    def __init__(
        ...
        self.model = SHVNET()
        self.memories = torch.randn(1, 5024, 768)
        self._output = None
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss =  loss_function(outputs1, outputs2,action)
